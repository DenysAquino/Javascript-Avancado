...
export class NegociacaoDao {
    ...
    listaTodos() {
        ...
        return new Promise((resolve, reject) => {
            ...
            let cursor = this._connection.transaction([this._store], 'readwrite').objectStore('negociacoes').openCursor();
    ...
    apagaTodos() {
        return new Promise((resolve, reject) => {
            ...
            let request = this._connection.transaction([this._store], 'readwrite').objectStore('negociacoes').clear();
